...
manifest = {
    ...
    'font_path': font_path,
    'author_override': 'Times New Roman and black axes/text; no generic sans-serif substitution.',
    'dimensions_mm': [188, 143],
    'layout': {'row_title_baselines_aligned': True, 'lower_xaxis_labels_aligned': True,
               'axes_vertical_gap_mm': (.64 - .50) * 143,
               'previous_axes_vertical_gap_mm': (.625 - .45) * 160,
               'upper_axes_horizontal_gap_mm': (.735 - .595) * 188,
               'previous_upper_axes_horizontal_gap_mm': (.755 - .595) * 188,
               'lower_axes_horizontal_gap_mm': (.61 - .44) * 188,
